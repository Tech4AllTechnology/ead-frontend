  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="application">
        ...
        <el-input
          ref="application"
          v-model="loginForm.application"
          :placeholder="$t('login.application')"
          name="application"
          type="text"
          auto-complete="on"
        />
...
export default {
  ...
  data() {
    ...
    const validateApplication = (rule, value, callback) => {
        if (value.length < 6) {
            callback(new Error('A matricula não tem caracteres suficientes.'))
        } else {
            callback()
        }
    }
